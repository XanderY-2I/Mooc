...
import com.tianji.chat.model.OpenAiModelProvider;
import com.tianji.chat.model.LlmModelProvider;
...
public class AiConfig {
    ...
    public LlmModelProvider llmModelProvider() {
        return new OpenAiModelProvider(baseUrl, apiKey, modelName,
                maxTokens, timeoutSeconds, maxRetries,
                chatModelTemperature, streamingChatModelTemperature);
    }
